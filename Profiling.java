...
import java.util.Scanner;
    ...
    public class MyProfiling {
        ...
        public static void main(String[] args) {
           ...
           while(profile){
               System.out.println("-----------------------------------------------------------------------------------------");
               System.out.println("Do you wish to add a profile?");
           ...
           System.out.println("Enter profile # "+u);
               ...
               while(r){
                   System.out.println("------------------------------------------------------------------------------------------");
               System.out.println("Which action you would like to do?");
               ...
               switch(w){
                   case 1: 
                       System.out.println("Enter the name you wish to view");
                       sc.nextLine();
